...
public class Word {
    ...
    public static class WordDBEntry implements BaseColumns {
        ...
        public static void addTestWordsToDB(SQLiteDatabase db) {
            ...
            values.put(WORD, AppLan.getAppContext().getResources().getString(R.string.about));
            db.insert(TABLE_NAME, null, values);
            values.clear();
            values.put(WORD, AppLan.getAppContext().getResources().getString(R.string.again));
            db.insert(TABLE_NAME, null, values);
            values.clear();
            values.put(WORD, AppLan.getAppContext().getResources().getString(R.string.chief));
            db.insert(TABLE_NAME, null, values);
            values.clear();
            db.insert(TABLE_NAME, null, values);
            values.clear();
            ...
            db.insert(TABLE_NAME, null, values);
            values.clear();
            values.put(WORD, AppLan.getAppContext().getResources().getString(R.string.ball));
            db.insert(TABLE_NAME, null, values);
            values.clear();
            values.put(WORD, AppLan.getAppContext().getResources().getString(R.string.body));
            db.insert(TABLE_NAME, null, values);
            values.clear();
            // db.close();
        }
